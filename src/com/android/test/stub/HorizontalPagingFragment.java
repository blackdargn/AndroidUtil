...
import com.android.util.widget.PagerAdapter;
import com.android.util.widget.ViewPager;
...
public class HorizontalPagingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.test_horizontal_fragment, container, false);
    ...
    public static class HorizontalPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            View v = mLayoutInflater.inflate(R.layout.test_page, container, false);
