...
* @author Doug Lea
*/
public abstract class ImageTAsyncTask<Params, Progress, Result> {
    private static final String LOG_TAG = "ImageTAsyncTask";
    ...
    public ImageTAsyncTask() {
        this(null);
    }

    public ImageTAsyncTask(String tag) {
    ...
    public final ImageTAsyncTask<Params, Progress, Result> execute(Params... params) {
        return executeOnExecutor(sDefaultExecutor, params);
    }

    public final ImageTAsyncTask<Params, Progress, Result> executeOnExecutor(SerialExecutor exec,
            Params... params) {
    ...
    private static class AsyncTaskResult<Data> {
        final ImageTAsyncTask mTask;
        final Data[] mData;

        AsyncTaskResult(ImageTAsyncTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
