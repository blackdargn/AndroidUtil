...
public final class CacheStrategy {
  ...
  public static boolean isCacheable(Response response, Request request) {
    ...
    // add by zdh
    if (responseCaching.noStore() && request.header("offline-cache") == null) {
      return false;
    }
  ...
  public static class Factory {
    ...
    private CacheStrategy getCandidate() {
      ...
      // ### add by zdh
      ResponseSource responseSource = request.header("offline") == null ? (hasConditions(conditionalRequest)
          ? ResponseSource.CONDITIONAL_CACHE
          : ResponseSource.NETWORK) : ResponseSource.CACHE;
